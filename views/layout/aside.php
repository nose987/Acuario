...
<nav>
  ...
  <?php 
    ...
    if($_SESSION['rol_id'] === 1){
      ...
      <a href="panel.php" class="nav-link" data-section="salud"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 6C 15 6, 18 8, 18 12C 18 16, 15 18, 12 18C 9 18, 6 16, 6 12C 6 8, 9 6, 12 6"fill="none"stroke="currentColor"stroke-width="2"/><path d="M12 9 L12 15 M9 12 L15 12" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>Salud de especies</a>
