    ...
    <div class="contenido">
        ...
        <div class="tabla">
            ...
            <form method="get" action="" class="buscador">
                <input type="text" name="busqueda" id="busqueda" value="" placeholder="Buscar" class="input" onkeyup="buscarTanque()">
                    ...
                    <?php if (!empty($tanques)): ?>
                        <?php foreach ($tanques as $tanque): ?>
                            <tr>
                                ...
                                <td><?php echo $tanque['nombre_area']; ?></td>
                                <td><?php echo $tanque['nombre_especie']; ?></td>
