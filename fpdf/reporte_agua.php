...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(175, 10, utf8_decode("REPORTE DEL REGISTRO DE LA CALIDAD DEL AGUA "), 0, 1, 'C', 0);
      $this->Ln(7);
      ...
      $this->Cell(39, 10, utf8_decode('Registro'), 1, 0, 'C', 1);
      $this->Cell(39, 10, utf8_decode('pH'), 1, 0, 'C', 1);
      $this->Cell(39, 10, utf8_decode('Amoniaco'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('Nitrato'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('Niritos'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('Tanque'), 1, 0, 'C', 1);
...
if ($result && $result->num_rows > 0) {
   while ($row = $result->fetch_assoc()) {
      $pdf->Cell(39, 10, utf8_decode($row['pk_agua']), 1, 0, 'C', 0);
      $pdf->Cell(39, 10, utf8_decode($row['ph']), 1, 0, 'C', 0);
      $pdf->Cell(39, 10, utf8_decode($row['amoniaco']), 1, 0, 'C', 0);
      $pdf->Cell(40, 10, utf8_decode($row['nitrato']), 1, 0, 'C', 0);
      $pdf->Cell(40, 10, utf8_decode($row['nitritos']), 1, 0, 'C', 0);
      $pdf->Cell(40, 10, utf8_decode($row['fk_tanque']), 1, 0, 'C', 0);
      $pdf->Cell(40, 10, utf8_decode($row['fecha']), 1, 1, 'C', 0);
   }
} else {
